class ExhibitsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @exhibit.save
        format.html { redirect_to @exhibit, notice: 'Экспонат успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @exhibit.update(exhibit_params)
        format.html { redirect_to @exhibit, notice: 'Экспонат успешно отредактирован.' }
  ...
  def destroy
    @exhibit.destroy
    respond_to do |format|
      format.html { redirect_to exhibits_url, notice: 'Экспонат успешно удален.' }
