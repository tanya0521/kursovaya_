class HallsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hall.save
        format.html { redirect_to @hall, notice: 'Зал успешно создан.' }
  ...
  def update
    respond_to do |format|
      if @hall.update(hall_params)
        format.html { redirect_to @hall, notice: 'Зал успешно отредактирован.' }
  ...
  def destroy
    @hall.destroy
    respond_to do |format|
      format.html { redirect_to halls_url, notice: 'Зал успешно удален.' }
